...
<div class="vnkings_form col-md-12">
    <?php if(is_user_logged_in()) {
        ...
        <a style="color:#fff;margin:10px 0;" href="<?php bloginfo("url");?>/dang-bai" class="btn btn-primary" role="button">
        ...
        <table class="table table-bordered">
            ...
            <?php while ($vnkings->have_posts()) : $vnkings->the_post(); ?>
                ...
                <tr class="vnkings_mn">
                    ...
                    <td><a target="_blank" class="vnk3" href="<?php bloginfo('url');?>/chinh-sua-post?id=<?php echo $postid;?>"><i class="fa fa-pencil-square-o"></i> Sửa</a></td>
                </tr>
